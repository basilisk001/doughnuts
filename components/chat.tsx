                ...
                <div className="flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-2xl glass-effect shadow-border-medium transition-all duration-200 ease-out">
                  ...
                  <div className="flex flex-1 items-center">
                    <Input
                      ...
                      value={input}
                      autoFocus
                      className="flex-1 glass-effect border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-base placeholder:text-muted-foreground/60"
                    />
                    <Button
                      type="submit"
                      size="icon"
            ...
            <div className="flex items-center gap-3 p-4 rounded-2xl glass-effect shadow-border-medium transition-all duration-200 ease-out">
              ...
              <div className="flex flex-1 items-center">
                <Input
                  ...
                  onChange={(e) => setInput(e.target.value)}
                  value={input}
                  className="flex-1 glass-effect border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-base placeholder:text-muted-foreground/60 font-medium"
                  onKeyDown={(e) => {
